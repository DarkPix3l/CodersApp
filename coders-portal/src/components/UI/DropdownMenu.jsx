...
export default function DropdownMenu() {
  return (
    <Menu>
      <MenuButton className="hidden lg:inline-flex items-center gap-2 rounded-md bg-gray-800 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-inner shadow-white/10 focus:not-data-focus:outline-none data-focus:outline data-focus:outline-white data-hover:bg-gray-700 data-open:bg-gray-700">
        My account
      </MenuButton>
      <MenuItems
